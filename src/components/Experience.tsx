  ...
  const experiences = [
    {
      ...
      description: "Leading frontend development for payment infrastructure, leveraging design expertise to create intuitive user interfaces.",
      achievements: [
        "Architected design system used across 15+ product teams, reducing development time by 40%",
        "Built accessible payment flows serving 100M+ transactions with 99.9% uptime",
        "Led design-to-code process optimization, improving designer-developer collaboration",
        "Mentored 4 engineers on design implementation best practices and component architecture"
      ],
      technologies: ["React", "TypeScript", "Next.js", "Design Systems", "Tailwind CSS", "Figma"],
      highlight: true
    },
    {
      ...
      duration: "2020 - 2022",
      description: "Developed user-facing features for booking platform, applying design principles to enhance user experience.",
      achievements: [
        "Implemented responsive booking interface increasing mobile conversion by 32%",
        "Created component library with 50+ reusable components based on design system",
        "Optimized image loading and layout shifts, improving Core Web Vitals by 45%",
        "Collaborated with design team to establish design token system and implementation guidelines"
      ],
      technologies: ["React", "Redux", "Sass", "Storybook", "Jest", "Figma"],
      highlight: false
    },
    {
      ...
      duration: "2019 - 2020", 
      description: "Built creative tools and interfaces for Adobe Creative Cloud, bridging design and development workflows.",
      achievements: [
        "Developed UI components for Creative Cloud desktop apps used by 20M+ designers",
        "Implemented design specifications with 99% accuracy using advanced CSS techniques",
        "Built prototyping tools that reduced design-to-development handoff time by 50%",
        "Created documentation and guidelines for design system implementation"
      ],
      technologies: ["React", "Vue.js", "CSS3", "Adobe XD", "Electron", "Design Tokens"],
      highlight: false
    },
    {
      ...
      location: "Redmond, WA",
      duration: "2018 - 2019",
      description: "Contributed to Office 365 web applications while transitioning from graphic design to software development.",
      achievements: [
        "Translated design mockups into responsive web components for Office 365 suite",
        "Implemented accessibility features ensuring WCAG 2.1 AA compliance",
        "Built internal design system documentation and component showcase",
        "Applied print design principles to improve web typography and layout consistency"
      ],
      technologies: ["JavaScript", "React", "TypeScript", "CSS3", "Azure DevOps"],
      highlight: false
    }
  ];
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {designExperience.technologies.map((tech, idx) => (
                    <span key={idx} className="px-4 py-2 bg-purple-100 text-purple-800 hover:bg-purple-200 rounded-full text-sm font-medium transition-colors">
                      {tech}
                    </span>
                  ))}
                </div>
