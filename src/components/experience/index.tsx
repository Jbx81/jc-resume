...
import { experiences, designExperience } from './experience';
	...
	return (
		<section className="py-20 bg-white">
			<div className="max-w-7xl mx-auto px-6">
				...
				{/* Design Experience */}
				<div>
					<h3 className="text-3xl font-bold text-gray-900 mb-8 text-center">Design Background and Project Management Experience</h3>
						...
						<div className="relative bg-gradient-to-br from-purple-50/50 to-pink-50/50 rounded-2xl shadow-xl p-8 lg:p-10 border border-purple-200">
							{designExperience.map((desExp) => (
								<div key={desExp.id}>
									...
									<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-8">
										<div className="flex-1">
											<h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">{desExp.title}</h4>
											<h5 className="text-xl lg:text-2xl text-purple-600 font-semibold mb-4">{desExp.company}</h5>
