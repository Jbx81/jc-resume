...
import { GraduationCap, Award, Calendar, BookOpen, Palette } from 'lucide-react';
            ...
            <div className="space-y-8">
              {education.map((edu, index) => (
                <div key={index} className={`rounded-2xl p-6 shadow-lg border ${
                  ...
                  <div className="mb-4">
                    <h6 className="font-semibold text-gray-900 mb-2 text-sm">Key Coursework:</h6>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-indigo-100 mb-6 text-lg">
                Staying current with evolving frontend technologies while deepening design-to-code expertise.
              </p>
